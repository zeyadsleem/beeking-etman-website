...
<div class="mx-auto mt-12 max-w-md">
  ...
  <form method="post" action="?/signIn" use:enhance class="mt-6 space-y-4 rounded-2xl border border-stone-200 bg-white p-6">
    ...
    <label class="block text-sm font-medium">
      كلمة المرور
      <input name="password" type="password" autocomplete="current-password" required class="mt-1 w-full rounded-xl border border-stone-300 px-3 py-2 focus:border-honey-500 focus:ring-honey-500" />
    </label>
